    ...
    var docDefinition =
      ...
      content: [
...

        {
          ...
          table: {
            body:[
              ['Inseam', 'Torso', 'Arm', 'Foot Length', 'Effective Top Tube', 'Standover', 'Seat Tube Length', 'Seat Tube Angle', 'Head Tube Length', 'Stack'],
              ['' + $scope.inseam, '' + $scope.torso, '' + $scope.arm, '' + $scope.footLength,  '' + $scope.effectiveTopTube, '' + $scope.standover, '' + $scope.standover, '' + $scope.seatTubeAngle, '' + $scope.headTubeLength, '' + $scope.stack],
            ]
            }
          },

          {
            ...
            table: {
              body:[
                ['Reach', 'Wheel Base', 'Chainstay Length', 'Bottom Bracket Drop', 'Axle to Crown', 'echanical Trail', 'Fork Offset'],
                ['' + $scope.reach, '' + $scope.wheelBase, '' + $scope.chainstayLength, '' + $scope.bbDrop, '' + $scope.axleToCrown, '' + $scope.mechanicalTrail, '' + $scope.forkOffset],
              ]
              }
            },
      ]
